...
usersRouter.use("/shopperlogin", require('./auth/shopper-login-account')); // url: ~/user/login
...
usersRouter.use("/shoppernew", require('./dao/create-new-shopper')); // url: ~/user/login
...
usersRouter.use("/shopperdashboard", require('./gui/shopper-dashboard')); // url: ~/user/dashboard
...
usersRouter.use("/dashboard/all-order-history", require('./gui/show-all-users-orders')); // url: ~/user/dashboard/order-history
