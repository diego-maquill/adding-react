...
module.exports = credentialsControllers = {
        ...
        return credentials().then((credentialsCollection) => {
                ...
                return credentialsCollection.findOne({
                    ...
                    .then((credentialInfo) => {
                        ...
                        if (bcryptjs.compareSync(password, credentialInfo.password)) {
    ...
    generateCredential: ((email) => {
        return credentials().then((credentialsCollection) => {
                ...
                credentialsCollection.updateOne({
                    _id: email
                }, {
                    $set: credentialChanges
                });
    ...
    updateCredential: (email, password, savedPassword) => {
        return credentials().then((credentialsCollection) => {
                ...
                if (password) {
                    ...
                    if (bcryptjs.compareSync(password, savedPassword)) {
    ...
    deleteCredential: (email) => {
        return credentials().then((credentialsCollection) => {
                // deleting a record
                return credentialsCollection.removeOne({
                        _id: email
                    })
